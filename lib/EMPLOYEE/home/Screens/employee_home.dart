                  ...
                  children: [
                    ...
                    Center(
                      child: SizedBox(
                        ...
                        child: Text(
                          "Hi  ${staffProfileController.model().data?.firstName??''} ${staffProfileController.model().data?.lastName??''}",
                                    ...
                                    child: Row(
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              '${homeController.model().data?[index].customer?.firstName.toString().capitalizeFirst} ${homeController.model().data?[index].customer?.lastName.toString().capitalizeFirst}',
                                            ...
                                            Text(
                                              '${homeController.model().data?[index].bookingDate}',
                                        ...
                                        GestureDetector(
                                            ...
                                            child: SvgPicture.asset(
                                                "assets/images/emp_accept_home.svg")),
                                        SizedBox(
                                          width: SizeConfig.screenWidth * 0.025,
                                        ),
                                        GestureDetector(
                                            ...
                                            child: SvgPicture.asset(
                                                "assets/images/emp_reject_home.svg")),
                                        // accept_rej_lst[index] == 0
                                        //     ? GestureDetector(
                                        //         onTap: () {
                                        //           setState(() {
                                        //             accept_rej_lst.clear();
                                        //           });
                                        //         },
                                        //         child: Text(
                                        //           "Accepted",
                                        ...
                                        //         ))
                                        //     : accept_rej_lst[index] == 1
                                        //         ? Text(
                                        //             "Rejected",
                                        //             style: font_style.red_600_16,
                                        //           )
                                        //         : const Text(""),
                                      ],
                                    ),
                                ...
                                child: Row(
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          "${homeController.bookingHistoryModel().data?[index].firstName ?? ''} ${homeController.bookingHistoryModel().data?[index].lastName ?? ''}",
                                          style: font_style.black_500_16,
                                        ),
                                        SizedBox(
                                          height:
                                    ...
                                    Column(
                                      children: [
                                        Text(
                                          "₹${double.parse(homeController.bookingHistoryModel().data?[index].amount.toString() ?? '').toStringAsFixed(2)}",
